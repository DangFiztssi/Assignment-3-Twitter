...
public class RestClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "vIyYpblBHHcDFmLhXwmx6rGeE";       // Change this
	public static final String REST_CONSUMER_SECRET = "YazISOfxDe5nAoVllWPyOhmbbnzPhZTj9aIEmFRPEDeRnb8Wju"; // Change this
